  ...
  <div className="container grid gap-8 px-6 py-12 mx-auto lg:grid-cols-3">
    ...
    <div className="grid grid-cols-1 gap-12 lg:col-span-2 sm:grid-cols-2 ">
      <div className="p-4 rounded-lg  md:p-6 dark:bg-gray-800">
        <span className="inline-block p-3 text-gray-900 rounded-lg shadow dark:bg-gray-700">
        ...
        <a href="mailto:mk3705200@gmail.com" className="mt-2 text-sm text-gray-700">hello@merakiui.com</a>
      ...
      <div className="p-4 rounded-lg  md:p-6 dark:bg-gray-800">
        ...
        <p className="mt-2 text-sm text-gray-700">Start new chat</p>
      ...
      <div className="p-4 rounded-lg  md:p-6 dark:bg-gray-800">
        ...
        <p className="mt-2 text-sm text-gray-700">100 Smith Street Collingwood VIC 3066 AU</p>
      ...
      <div className="p-4 rounded-lg  md:p-6 dark:bg-gray-800">
        ...
        <p className="mt-2 text-sm text-gray-700">+1 (555) 000-0000</p>
